 ...
 * 
 */
public class MySimpleSelectByPrimaryKeyElementGenerator extends SimpleSelectByPrimaryKeyElementGenerator {

	public MySimpleSelectByPrimaryKeyElementGenerator() {
		super();
	}
